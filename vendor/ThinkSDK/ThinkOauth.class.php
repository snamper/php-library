...
abstract class ThinkOauth{
    ...
    public static function getInstance($type, $token = null) {
    	...
    	require_once THINK_PATH."Library/Think/ThinkSDK/sdk/{$name}.class.php";
	 ...
	 */
     private function config(){
        $config=Addon::getConfig('Oauthlogin');
       //$Callback=$config['callback']."?type="."{$this->Type}" ;
	   $Callback = $config['callback'].addons_url('Oauthlogin://Oauthlogin/callback',array('type'=>"{$this->Type}")); 
	 //  U('home/addons/execute',array('_addons'=>'Oauthlogin','_controller'=>'Oauthlogin','_action'=>'callback',type=>"{$this->Type}"),true,false,true);
